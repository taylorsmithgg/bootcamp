...
public class DownloadedFilesPanel extends FilePanel
{
	private static final long		serialVersionUID	= -5369440416901092735L;
	...
	public DownloadedFilesPanel(final String downloadPath)
	{
		super(UPLOAD_BACKGROUND);

		this.downloadPath = downloadPath;

		statusLabel.setText("Downloaded Files");
		...
		openMenuItem.addActionListener(new ActionListener()
		{
			...
			{
				final String fileName = downloadPath + model.get(popupIndex);
	...
	{
		final File[] files = downloadDirectory.listFiles(new FileFileFilter());
	...
	{
		final String fileName = downloadPath + model.get(list.locationToIndex(mouseEvent.getPoint()));
